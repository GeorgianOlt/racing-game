...
//
//        carReference =  car2;
//        System.out.println("Name of car referenced from two variables CarReference: " + carReference.name);
//        System.out.println("Name of car referenced from two variables Car2: " + car2.name);
//
//        car2.name = "Dacia";
//
//        System.out.println("Updated Name of car referenced from two variables CarReference : " + carReference.name);
